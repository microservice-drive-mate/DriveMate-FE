...
export const ERROR_MESSAGES = {
	...
	STUDENT_PROFILE_INVALID: 'Hồ sơ học viên chưa đầy đủ. Vui lòng cập nhật hạng bằng trong hồ sơ.',
	...
	INVALID_MIME_TYPE: 'Định dạng tệp không được hỗ trợ. Vui lòng chọn ảnh khác.',
	...
	EXAM_TEMPLATE_VERSION_CONFLICT: 'Đề thi đã được cập nhật. Vui lòng thử lại.',
	...
	INSUFFICIENT_QUESTION_POOL: 'Không đủ câu hỏi để tạo đề thi. Vui lòng liên hệ trung tâm.',
	...
	STUDENT_LICENSE_NOT_ASSIGNED: 'Tài khoản của bạn chưa được gán hạng bằng. Vui lòng liên hệ trung tâm.',
};
